...
6. [Users & Roles](#07-users--roles)
7. [Roles & Permissions Matrix](#08-roles--permissions-matrix)
9. [Event Lifecycle](#10-event-lifecycle)
10. [Customer Journey](#11-customer-journey)
11. [Organizer Journey](#12-organizer-journey)
12. [Event Templates](#13-event-templates)
13. [Inventory Management](#14-inventory-management)
14. [Payments](#15-payments)
15. [QR Tickets](#16-qr-tickets)
16. [Seat Locking](#17-seat-locking)
17. [Event Updates](#18-event-updates)
18. [Cancellation & Refund](#19-cancellation--refund)
19. [Notifications](#20-notifications)
20. [Categories](#21-categories)
21. [Assumptions](#22-assumptions)
22. [Out of Scope (MVP)](#23-out-of-scope-mvp)
...
Ticket-Souq centralizes this fragmented experience into a unified platform, providing a single, seamless interface for customers and a comprehensive management system for event organizers.
...
The platform provides an interactive seat map editor that allows organizers to create venue layouts, define sections, arrange seats, and configure seat properties before publishing an event.
...
- Browsing events
- Searching events with intelligent matching, allowing users to find relevant events despite typos or incomplete queries.
- Receiving a QR code as a ticket
- Viewing reserved events in a timeline list
- Reserving more than one ticket (max 5), each of which must be named for a specific attendee
...
2. **Agent** _(Consumer authorities, plus:)_
...
3. **Organization Head** _(Agent authorities, plus:)_
...
3. Submit
4. Published _(visible to customers)_
5. Reservations open
...
**Book & Pay** 4. Select seat or zone 5. Reserve _(temporary lock for 10 min starts)_ 6. Payment 7. QR generation

**Attend** 8. Attend event 9. QR validation _(scanned at entry)_
...
6. Org Head monitors reservations via analysis dashboard
7. Agent/Org Head issues updates as needed (bounded by Event Updates rules)
8. On event day, Consumer/Agent validates tickets via QR scan
...
1. Reservation created _(seat/zone locked)_
2. Checkout initiated _(redirect or simulated call)_
...
2. Seat temporarily locked _(TTL countdown starts)_
...
- Increase ticket prices for unbooked seats or available zones.
- Modify details of unbooked seats.
- Increase the available capacity of a zone-based event.
